package JavaLab_01_NumberofDayinMonth;
import java.util.Scanner;
import java.util.Objects;
/*public static boolean Checkmonth(String str) {
	return (Objects.equals(str,"January")||Objects.equals(str, "Jan.")||Objects.equals(str, "Jan"));
}*/
public class DayInMonth {
	public static void main(String[] args) {
		...
		/*if( (yearInInt%4 == 0 && yearInInt%100 != 0 ) || (yearInInt % 100 == 0 && yearInInt % 400 == 0 )) {
			System.out.println("Leap year");
		}
		System.out.println("Comparing " + month + " and " + year
                + " : " + Objects.equals(month, year));*/
